...
<%
	/*
		요청 URL
			localhost/comn/product/insert.jsp
		요청 파라미터
			catNo=xxx
			&comNo=xxx
			&statusNo=xxx
	...
	*/
	...
	// Product 클래스의 정적 메소드 createProduct(값,값,값,값...)을
	...
	for(String value : eventNoArr) {
		int evectNo = Integer.valueOf(value);
		...
		// ProductEvent는 상품정보(no=번호, cat=카테고리, company=제조사정보...)
